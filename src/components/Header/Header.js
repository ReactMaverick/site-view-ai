                        ...
                        >
                            <Box sx={MUIStyle.HeadermobInner}>
                                ...
                                <Box component={"ul"} sx={MUIStyle.HEaderMenu}>
                                    ...
                                    <Box component={"li"} sx={MUIStyle.HEaderMenuLi}>
                                        <Link className={"headerMenu" + (pathName === "/Why-siteview" ? " active" : "")} href="/aboutUs" >
                                            <Typography component={'p'} sx={MUIStyle.HeaderMenuBtn}>Why SiteView</Typography>
                                        </Link>
                                    </Box>
                                    <Box component={"li"} sx={MUIStyle.HEaderMenuLi}>
                                        <Link className={"headerMenu" + (pathName === "/our-tech" ? " active" : "")} href="/service" >
                                            <Typography component={'p'} sx={MUIStyle.HeaderMenuBtn}>Our Tech</Typography>
                                        </Link>
                                    </Box>
                                    <Box component={"li"} sx={MUIStyle.HEaderMenuLi}>
                                        <Link className={"headerMenu" + (pathName === "/blogs" ? " active" : "")} href="/caseStudy" >
                                            <Typography component={'p'} sx={MUIStyle.HeaderMenuBtn}>Blogs</Typography>
                                        </Link>
                                    </Box>
                                    <Box component={"li"} sx={MUIStyle.HEaderMenuLi}>
                                        <Link className={"headerMenu" + (pathName === "/faq" ? " active" : "")} href="/contactUs" >
                                            <Typography component={'p'} sx={MUIStyle.HeaderMenuBtn}>FAQ</Typography>
                                        </Link>
                                    </Box>
                                    <Box component={"li"} sx={MUIStyle.HEaderMenuLi}>
                                        <Link className={"headerMenu" + (pathName === "/contactUs" ? " active" : "")} href="/contactUs" >
