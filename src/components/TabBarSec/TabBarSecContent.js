import { DOCDATA, ONSITEMANAGEMENT, PLANNINGMONITORING, PROGRESSTRACKING, QUALITYCONTROL, REMOTECOLLABORATION, SAFETYMANAGEMENT, SUSTAINIBILITY, TABIMAGE1, TABIMAGE2, TABIMAGE3, TABIMAGE4, TABIMAGE5 } from "@/values/Constants/ImageConstants";
...
export const tabBarSecContentImages = {
    "WhySiteView": [ONSITEMANAGEMENT, REMOTECOLLABORATION, QUALITYCONTROL, PLANNINGMONITORING, PROGRESSTRACKING, SUSTAINIBILITY, SAFETYMANAGEMENT, DOCDATA],
    "OurTech": [TABIMAGE5, TABIMAGE2, TABIMAGE3, TABIMAGE4, TABIMAGE1]
}
