...
export const BANNER1 = URL('/images/next1sec.jpg');
export const DASHBOARD = URL('/images/360degimg.png');
export const PARTNERSLOGO1 = URL('/images/logos/image1.png');
export const PARTNERSLOGO2 = URL('/images/logos/image2.png');
export const PARTNERSLOGO3 = URL('/images/logos/image3.png');
...
export const VIDEOBG1 = URL('/images/VideoBg.jpg');
...
export const CTABG = URL('/images/CTASection.jpg');
export const LINEARROW = URL('/images/Linearrow.png');
export const VIDEOINNER = URL('/images/Video.jpg');
...
export const VISION1 = URL('/images/vision_1.gif');
export const VISION2 = URL('/images/vision_2.gif');
...
export const BLOG3 = URL('/images/Blog3.jpg');
export const BLOG4 = URL('/images/Blog4.png');
export const BLOG5 = URL('/images/Blog5.png');
export const BLOG6 = URL('/images/Blog6.png');
...
export const EXECUTION = URL('/images/execution.jpg');
export const TRYNOW = URL('/images/try-now.jpg');
...
export const INFRAENGG = URL('/images/infra-engg.jpg');
